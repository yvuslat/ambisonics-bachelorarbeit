...
X_src = [([4.6; 2.25; 1.65]),([4.6; 2.25; 1.65]),([4.6; 2.25; 1.65])];
...
for i = 1:3
    ...
    save([pwd filesep rirname filesep rirname sprintf('_src_%i.mat', Src_number)],'IRs','Pos','yaw_rcv','pitch_rcv','roll_rcv','X_rcv','X_src(:,i)','room','-v7.3');
end    